...
There is `babel-sublime` by [@garetmckinley](https://github.com/garetmckinley) to add support for `styled-components`!

All you have to do is install and use `babel-sublime` to highlight your JavaScript files!
