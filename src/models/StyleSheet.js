...
export const createStyleSheet = (SC_ATTR: string) => {
  ...
  return class StyleSheet {
    ...
    makeTag(tag: ?Tag<any>): Tag<any> {
      ...
      return makeTag(SC_ATTR, this.target, lastEl, this.forceServer, insertBefore, this.getImportRuleTag);
    }
...
const StyleSheet = createStyleSheet(SC_ATTR);
