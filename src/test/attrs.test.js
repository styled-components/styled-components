...
describe('attrs', () => {
  ...
  it('should replace attrs with props', () => {
    ...
    expect(TestRenderer.create(<Comp />).toJSON()).toMatchSnapshot()
    expect(
      TestRenderer.create(<Comp type="reset" />).toJSON()
    ).toMatchSnapshot()
    expect(
      TestRenderer.create(<Comp type="reset" tabIndex="-1" />).toJSON()
    ).toMatchSnapshot()
  })
  ...
  it('should override children of course', () => {
    ...
    expect(
      TestRenderer.create(<Comp>Something else</Comp>).toJSON()
    ).toMatchSnapshot()
  })
  ...
  it('should shallow merge "style" prop + attr instead of overwriting', () => {
    ...
    expect(
      TestRenderer.create(<BlueText>Hello</BlueText>).toJSON()
    ).toMatchSnapshot()
  })
})
