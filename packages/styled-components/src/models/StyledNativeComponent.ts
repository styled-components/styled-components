...
function useResolvedAttrs<Props extends object, Theme extends object = DefaultTheme>(
  theme: Theme = EMPTY_OBJECT as Theme,
  props: Props,
...
>(
  forwardedComponent: IStyledComponent<'native', Props, Theme>,
  props: Props,
...
export default function reactNativeComponentFactory(
  InlineStyle: IInlineStyleConstructor<any, any>
) {
  const createStyledNativeComponent = <
    Target extends NativeTarget,
    Theme extends object = DefaultTheme,
    OuterProps extends ExecutionProps<Theme> = BaseObject,
    Statics extends object = BaseObject,
  >(
    target: Target,
    options: StyledOptions<'native', OuterProps, Theme>,
    rules: RuleSet<OuterProps, Theme>
  ): ReturnType<IStyledComponentFactory<'native', Target, OuterProps, Statics, Theme>> => {
    const isTargetStyledComp = isStyledComponent(target);
    const styledComponentTarget = target as IStyledComponent<'native', OuterProps, Theme>;
