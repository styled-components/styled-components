  ...
  return (
    <Stack>
      ...
      <Row>
        ...
        <Markdown variant="hint">
          Independent longhand registration: `text-wrap-mode` sets the mode without touching style.
        </Markdown>
        <Ribbon>
      ...
      <Row>
        ...
        <Markdown variant="hint">
          Independent longhand registration: `text-wrap-style` sets the style without touching mode.
        </Markdown>
        <NarrowFrame>
