...
- Describe behavior as it currently is. No journey narration ("previously", "no longer", "now", "replaces", "instead of", "rather than") for states no released version shipped; fold a fix on a still-unreleased feature into that feature's changeset.
