...
- Use much faster CSS injection in the browser, thanks to [@schwers](https://github.com/schwers) (see [#1208](https://github.com/styled-components/styled-components/pull/1208))
