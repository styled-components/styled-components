...
* Add warnings for the upcoming removal of the `injectGlobal` and `extend` APIs in v4.0, by [@probablyup](https://github.com/probablyup) (see [#1909](https://github.com/styled-components/styled-components/pull/1909))
